...
@section('page-header')
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                <h4 class="content-title mb-0 my-auto">Services</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/ Insurance</span>
            </div>
        </div>
    </div>
    <!-- breadcrumb -->
                        ...
                        <table class="table text-md-nowrap text-center" id="example1">
                            ...
                            @foreach($insurances as $insurance)
                                <tr>
                                    ...
                                    <td class="{{$insurance->status == 1 ? 'bg-success':'bg-danger'}}">{{$insurance->status == 1 ? 'Enanled' : 'Not Enabled'}}</td>
